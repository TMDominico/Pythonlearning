...
class CoinBox:  # {10: 11, 50: 2, 100: 1, 500: 21, 1000: 23}
    def __init__(self, products, defaultcoins):
        ...
        self.smallestprice = sorted(self.products.values())[0]
...
class VendingMachine:
    def __init__(self, products, defaultcoins):
        ...
        for key in self.products.keys():
            self.productsdic[i] = [key, self.products.get(key)]
            i += 1
        print(self.productsdic)
        self.cbox = CoinBox(products, defaultcoins)
        self.sold = {}
...
vendingmachine1 = VendingMachine({"커피": 300, "콜라": 500, "물": 100},
                                 {10: 0, 50: 2, 100: 1, 500: 0, 1000: 23})
